        ...
        <form id="registro" class="registro" action="index.html" method="POST">
            <div id="datos_usuarios" class="registro caja clearfix">
                <div class="campo">
                    ...
                    <input type="text" id="nombre" name="nombre" placeholder="Tu Numobre">
                </div>
                <div class="campo">
                    <label for="apellido">Apellido:</label>
                    <input type="text" id="apellido" name="apellido" placeholder="Tu Appellido">
                </div>
                <div class="campo">
            ...
            <div id="resumen" class="resumen">
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        ...
                        <!--orden-->
                        <div class="orden">
                            <label for="etiquetas">Paquetes de 10 etiquetas $2<small>(HTML5, CSS3, JavaScripts, Chrome)</small></label>
                        ...
                        <div class="orden">
                            ...
                            <select id="regalo" required>
                                ...
                                <option value="PLU">Pulseras</option>
